    ...
    return(
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-50 dark:bg-gray-900">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 "> 
                <div className="group hover:shadow-2xl transition-shadow duration-300 border-1 border-gray-300 rounded-xl  dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <div className="p-6">
                        <h3 className="text-2xl mb-3 font-medium text-gray-900 dak:text-white">Sistema de Gestão</h3>
                        ...
                        <div className="flex flex-wrap gap-2 mb-4 pb-3 border-b border-gray-300">
                            <span className="bg-gray-200 py-1 px-3 rounded-4xl">React</span>
                            <span className="bg-gray-200 py-1 px-3 rounded-4xl">React</span>
                            <span className="bg-gray-200 py-1 px-3 rounded-4xl">React</span>
                        </div>
            ...
            <div className="text-center mt-12"><button className="py-2 px-4 ring-1 ring-gray-300 rounded-md">Ver Todos os Projetos <span>→</span></button></div>
        </section>
    )
}

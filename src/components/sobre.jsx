...
function Sobre(){
    return(
        <main id="sobre" className="max-w-full pt-16 pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden bg-white w-screen dark:bg-gray-900">
            <section  className="grid md:grid-cols-2 items-center gap-8 p-8 mx-auto">
                <div className="flex flex-col gap-12 items-cente ">
                    ...
                    <p className="text-xl text-gray-600 dark:text-gray-400 max-w-xl"> Com mais de 5 anos de experiência no mercado, já ajudamos dezenas de empresas a crescerem através da tecnologia. 
